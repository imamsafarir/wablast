@php
    $logoUrl = \App\Models\AppSetting::getLogoUrl();
@endphp

@if ($logoUrl)
    <img src="{{ $logoUrl }}" alt="{{ \App\Models\AppSetting::getSiteName() }}"
        {{ $attributes->merge(['class' => 'object-contain']) }}>
@else
    <div {{ $attributes->merge(['class' => 'flex items-center justify-center text-[#128C7E]']) }}>
